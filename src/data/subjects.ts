...
export const subjects: Subject[] = [
  ...
  },
  {
    ...
    chapters: [
      {
        slug: 'quest-ce-quune-organisation',
      ...
      },
      {
        ...
        title: 'Les critères de différenciation des organisations',
        theme: "Qu'est-ce qu'une organisation ?",
        themeNumber: 1,
      ...
      },
      {
        ...
        title: 'Le management stratégique et opérationnel',
      ...
      {
        slug: 'la-performance',
        title: 'La performance de l\'organisation',
        theme: 'Comment le management permet-il de répondre aux changements ?',
        themeNumber: 2,
